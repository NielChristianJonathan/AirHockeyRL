...
class AirHockeyGame:
    ...
    def get_user_feedback(self):
        ...
        while waiting:
            ...
            # Border biar lebih jelas
            pygame.draw.rect(self.screen, (255, 255, 255), popup_rect, 2, border_radius=10)

            # 📝 Teks
            text = font.render("Agent good? (Y / N)", True, (255, 255, 255))
    ...
    def save_feedback(self, trajectory, feedback):
        data = {
    ...
    def run(self):
        ...
        while running:
            if self.state == "game_over" and not self.feedback_given:
                ...
                self.save_feedback(self.trajectory, feedback)
